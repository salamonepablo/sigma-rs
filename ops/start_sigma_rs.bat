...
REM the PowerShell script `ops\servidor_auto.ps1` from the project directory.
...
powershell -NoProfile -ExecutionPolicy Bypass -Command "Start-Process powershell -ArgumentList '-NoProfile -ExecutionPolicy Bypass -File \"%PROJECT%\ops\servidor_auto.ps1\"' -WindowStyle Minimized"
