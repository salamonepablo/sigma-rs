        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "employee_number",
                    models.CharField(
                        max_length=20, unique=True, verbose_name="Número de legajo"
                    ),
                ),
                (
                    "email",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "date",
                    models.DateField(
                        help_text="Fecha de la avería", verbose_name="Fecha"
                    ),
                ),
                (
                    "entry_type",
                ...
                (
                    "notification_time",
                    models.TimeField(
                        blank=True, null=True, verbose_name="Hora de aviso"
                    ),
                ),
                (
                    "intervention_time",
                    models.TimeField(
                        blank=True, null=True, verbose_name="Hora de intervención"
                    ),
                ),
                (
                    "delivery_time",
                    models.TimeField(
                        blank=True, null=True, verbose_name="Hora de entrega"
                    ),
                ),
                (
                    "observations",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="tickets.affectedsystemmodel",
                        verbose_name="Sistema afectado",
                    ),
                ),
                (
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["ticket_number"], name="ticket_ticket__457ce8_idx"
                    ),
                    models.Index(fields=["date"], name="ticket_date_4c710e_idx"),
                    models.Index(fields=["status"], name="ticket_status_e60204_idx"),
                    models.Index(
                        fields=["maintenance_unit"], name="ticket_mainten_837ce0_idx"
                    ),
                ],
            },
        ),
